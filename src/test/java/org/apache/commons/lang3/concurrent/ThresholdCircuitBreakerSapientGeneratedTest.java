...
class ThresholdCircuitBreakerSapientGeneratedTest {
    ...
    //Sapient generated method id: ${checkStateWhenIsOpenNot}, hash: E669216CF7A7FF1F18CFE7D0EA89F32B
    @Test()
    ...
    //Sapient generated method id: ${checkStateWhenIsOpen}, hash: 6B0CAAA280BA0C506BA420FC448423DF
    @Test()
    ...
    //Sapient generated method id: ${closeTest}, hash: 70DF4F9551842493E2B646BC687E7145
    @Test()
    void closeTest() {
        //Arrange Statement(s)
        ThresholdCircuitBreaker target = spy(new ThresholdCircuitBreaker(0L));
    ...
    //Sapient generated method id: ${incrementAndCheckState1WhenCheckState}, hash: 1D71CE75F51501AEF4B3A0A6E4BF9113
    @Test()
    ...
    //Sapient generated method id: ${incrementAndCheckState1WhenCheckStateNot}, hash: F0D75A2B4DB01364EC1B705D30C7BED4
    @Test()
