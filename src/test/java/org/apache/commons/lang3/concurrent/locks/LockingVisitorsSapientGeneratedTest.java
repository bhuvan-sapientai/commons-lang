...
class LockingVisitorsSapientGeneratedTest {
    ...
    //Sapient generated method id: ${createTest}, hash: 369080DBDDF0AD2905A921741B89593C
    @Test()
    void createTest() {
        //Arrange Statement(s)
    ...
    //Sapient generated method id: ${reentrantReadWriteLockVisitorTest}, hash: 60723C0A476D494F7D9A902A8E9105F6
    @Test()
    void reentrantReadWriteLockVisitorTest() {
        //Arrange Statement(s)
        LockingVisitors.ReadWriteLockVisitor lockingVisitorsReadWriteLockVisitorMock = mock(LockingVisitors.ReadWriteLockVisitor.class);
    ...
    //Sapient generated method id: ${stampedLockVisitorTest}, hash: AB427C2774128E81767A84F3CC0B66AB
    @Test()
