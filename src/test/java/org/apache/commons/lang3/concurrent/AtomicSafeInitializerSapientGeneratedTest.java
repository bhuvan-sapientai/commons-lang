...
class AtomicSafeInitializerSapientGeneratedTest {
    ...
    void builderTest() {
        ...
        AtomicSafeInitializer.Builder<AtomicSafeInitializer<Object>, Object> atomicSafeInitializerBuilder = new AtomicSafeInitializer.Builder<>();
        //Assert statement(s)
        ...
        assertAll("result", () -> assertThat(result, equalTo(atomicSafeInitializerBuilder)));
    }
