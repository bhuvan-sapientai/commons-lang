...
class MutableByteSapientGeneratedTest {
    ...
    //Sapient generated method id: ${7e66bfb8-26f7-3df2-a81a-f2b50532e6b2}
    @Test()
    void byteValueTest() {
        //Arrange Statement(s)
        MutableByte target = new MutableByte((byte) 0);
    ...
    void intValueTest() {
        //Arrange Statement(s)
        MutableByte target = new MutableByte(0);
    ...
    //Sapient generated method id: ${121bc791-9d75-3a1f-a93e-518813e5dd43}
    @Test()
    void toByteTest() {
        //Arrange Statement(s)
        MutableByte target = new MutableByte((byte) 1);
