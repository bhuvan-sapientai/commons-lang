...
class MutableFloatSapientGeneratedTest {
    ...
    //Sapient generated method id: ${02d78267-01ae-3cbd-a70a-9b5fc16a82f2}
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${a6cecbd0-98c8-3baf-a031-52d95a84cbfa}
    @Test()
    ...
    //Sapient generated method id: ${b62696ef-e443-3940-a8d5-fcc3b8ff6ae1}
    @Disabled()
    @Test()
    ...
    //Sapient generated method id: ${0e507fba-c968-3e38-8e3c-c051d0fd0fc2}
    @Test()
    ...
    void addTest() {
        //Arrange Statement(s)
        MutableFloat target = new MutableFloat(Float.parseFloat("0.25"));
        //Act Statement(s)
        target.add(Float.parseFloat("0.25"));
    }
    ...
    void subtractTest() {
        //Arrange Statement(s)
        MutableFloat target = new MutableFloat(Float.parseFloat("0.5"));
        //Act Statement(s)
        target.subtract(Float.parseFloat("0.5"));
    }
    ...
    void addAndGetTest() {
        ...
        MutableFloat target = new MutableFloat(Float.parseFloat("0.25"));
        //Act Statement(s)
        float result = target.addAndGet(Float.parseFloat("0.25"));
        //Assert statement(s)
        assertAll("result", () -> assertThat(result, equalTo(Float.parseFloat("0.5"))));
    }
    ...
    void addAndGet1Test() {
        ...
        MutableFloat target = new MutableFloat(Float.parseFloat("1.0"));
        //Act Statement(s)
        float result = target.addAndGet(1);
        //Assert statement(s)
    ...
    void getAndAddTest() {
        ...
        MutableFloat target = new MutableFloat(Float.parseFloat("0.25"));
        //Act Statement(s)
        float result = target.getAndAdd(Float.parseFloat("0.25"));
        //Assert statement(s)
        assertAll("result", () -> assertThat(result, equalTo(Float.parseFloat("0.25"))));
    }
    ...
    void getAndAdd1Test() {
        ...
        MutableFloat target = new MutableFloat(Float.parseFloat("1.0"));
        //Act Statement(s)
        float result = target.getAndAdd(1);
        //Assert statement(s)
        assertAll("result", () -> assertThat(result, equalTo(Float.parseFloat("1.0"))));
    }
    ...
    //Sapient generated method id: ${5fdec44a-bd54-33b0-bed0-1ab711faab0c}
    @Test()
    void toFloatTest() {
        //Arrange Statement(s)
        MutableFloat target = new MutableFloat(Float.parseFloat("0.0"));
