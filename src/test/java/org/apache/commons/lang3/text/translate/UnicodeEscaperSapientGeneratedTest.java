...
class UnicodeEscaperSapientGeneratedTest {
    ...
    //Sapient generated method id: ${aboveTest}, hash: 014C64C453C4C4417A75AF20BF2319CC
    @Test()
    void aboveTest() {
        //Arrange Statement(s)
    ...
    //Sapient generated method id: ${belowTest}, hash: 8FC2E11020A6AB77B2B053B66CBCA565
    @Test()
    void belowTest() {
        //Arrange Statement(s)
        try (MockedStatic<UnicodeEscaper> unicodeEscaper = mockStatic(UnicodeEscaper.class, CALLS_REAL_METHODS)) {
    ...
    //Sapient generated method id: ${betweenTest}, hash: 0BF3EF62FE70469F64B63A1904A2D103
    @Test()
    void betweenTest() {
    ...
    //Sapient generated method id: ${outsideOfTest}, hash: FE1F6B4C1C4834449D0D5B7E2E9B80C0
    @Test()
    void outsideOfTest() {
    ...
    //Sapient generated method id: ${toUtf16EscapeTest}, hash: D3EED74C0C89D52B66D0B394D27AFB2C
    @Test()
    ...
    //Sapient generated method id: ${translate3WhenCodePointGreaterThanAbove}, hash: 4AE7ECD660467DFE7D4CE2C250ADA0CB
    @Test()
    ...
    //Sapient generated method id: ${translate3WhenCodePointNotGreaterThan65535}, hash: AB9697089B048ADCE2D5313044BD5764
    @Test()
    ...
    //Sapient generated method id: ${translate3WhenCodePointGreaterThanAboveAndCodePointGreaterThan65535}, hash: 1674E75FD3CB8D0B99559277E9DB780C
    @Test()
