...
class NumericEntityEscaperSapientGeneratedTest {
    ...
    //Sapient generated method id: ${aboveTest}, hash: 9530407A1EA55AAE28E030B039D0306F
    @Test()
    void aboveTest() {
        //Arrange Statement(s)
    ...
    //Sapient generated method id: ${belowTest}, hash: 2C22341855B76F80A49DB1F6FA400AFE
    @Test()
    void belowTest() {
        //Arrange Statement(s)
        try (MockedStatic<NumericEntityEscaper> numericEntityEscaper = mockStatic(NumericEntityEscaper.class, CALLS_REAL_METHODS)) {
    ...
    //Sapient generated method id: ${betweenTest}, hash: BD26FE7F0DADF4FB3BF82D3069E88539
    @Test()
    void betweenTest() {
    ...
    //Sapient generated method id: ${outsideOfTest}, hash: 060525F938981601BA8BE0CC6419DC2A
    @Test()
    void outsideOfTest() {
    ...
    //Sapient generated method id: ${translate3WhenCodePointLessThanBelow}, hash: 9B709969F071FC7F7D12834AD9EBB7C2
    @Test()
    ...
    //Sapient generated method id: ${translate3WhenCodePointNotGreaterThanAbove}, hash: 94C058895F07FE931D3C8AA31A1B73CD
    @Test()
