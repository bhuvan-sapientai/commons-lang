...
class FormattableUtilsSapientGeneratedTest {

    //Sapient generated method id: ${appendTest}, hash: 6E660DCC837C23EB3F5B96AB1C520B81
    @Test()
    void appendTest() {
        //Arrange Statement(s)
    ...
    //Sapient generated method id: ${append1Test}, hash: 176863796123E2E489D5BB28D37B6549
    @Test()
    void append1Test() {
        //Arrange Statement(s)
        try (MockedStatic<FormattableUtils> formattableUtils = mockStatic(FormattableUtils.class, CALLS_REAL_METHODS)) {
    ...
    //Sapient generated method id: ${append2WhenNotLeftJustify}, hash: A76DE6B6D47FDD46C450108135883CE1
    @Test()
    void append2WhenNotLeftJustify() {
        /* Branches:
         * (ellipsis == null) : true
         * (precision >= 0) : true
        ...
        //Act Statement(s)
        Formatter result = FormattableUtils.append("seq1", formatter, 0, 1, 0, 'A', charSequence);
        
        //Assert statement(s)
        assertAll("result", () -> assertThat(result, equalTo(formatter)));
    }

    //Sapient generated method id: ${append2WhenPrecisionLessThanSeqLengthAndFlagsAndFormattableFlagsLEFT_JUSTIFYEqualsFormattableFlagsLEFT_JUSTIFYAndILessT}, hash: ACDB6B9BBA9E19B21127786EADB601EE
    @Test()
    ...
    //Sapient generated method id: ${append3Test}, hash: 18DEB0443F6EFE3C0A6E8856B20B7F65
    @Test()
    void append3Test() {
        //Arrange Statement(s)
        try (MockedStatic<FormattableUtils> formattableUtils = mockStatic(FormattableUtils.class, CALLS_REAL_METHODS)) {
    ...
    //Sapient generated method id: ${toStringTest}, hash: DDB5E3D445CA60E755E2F601ABA571B2
    @Test()
    void toStringTest() {
        //Arrange Statement(s)
