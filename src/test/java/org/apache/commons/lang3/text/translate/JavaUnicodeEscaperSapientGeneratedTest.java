...
class JavaUnicodeEscaperSapientGeneratedTest {
    ...
    //Sapient generated method id: ${above1Test}, hash: 82EE621131A54836EE38EB0B446E0C05
    @Test()
    void above1Test() {
        //Arrange Statement(s)
    ...
    //Sapient generated method id: ${below1Test}, hash: 83E72683627876BC91B2A32EF4DFB73E
    @Test()
    void below1Test() {
        //Arrange Statement(s)
        try (MockedStatic<JavaUnicodeEscaper> javaUnicodeEscaper = mockStatic(JavaUnicodeEscaper.class, CALLS_REAL_METHODS)) {
    ...
    //Sapient generated method id: ${between1Test}, hash: F54D4368CCB5D1EF9ECBE38D6B3E218C
    @Test()
    void between1Test() {
    ...
    //Sapient generated method id: ${outsideOf1Test}, hash: 4AC5DF412FE7B7525EF90A1DBBB18CD0
    @Test()
    void outsideOf1Test() {
    ...
    //Sapient generated method id: ${toUtf16EscapeTest}, hash: B318250B040BCA7D7ABDF3B2BAB622E2
    @Test()
