...
class BitFieldSapientGeneratedTest {
    ...
    //Sapient generated method id: ${clearTest}, hash: 93BF9F0BFF43728654364991018986C6
    @Test()
    void clearTest() {
        //Arrange Statement(s)
    ...
    //Sapient generated method id: ${clearByteTest}, hash: 39A3B12BBCE30F313102428C76DFE5AB
    @Test()
    void clearByteTest() {
        //Arrange Statement(s)
        BitField target = new BitField(0);
    ...
    //Sapient generated method id: ${clearShortTest}, hash: 3F16CF4ED5C4ACDA70EDBC8260265E5C
    @Test()
    void clearShortTest() {
        //Arrange Statement(s)
        BitField target = new BitField(0);
    ...
    //Sapient generated method id: ${getRawValueTest}, hash: CF46630801BB5AC22602253BC66B6F71
    @Test()
    ...
    //Sapient generated method id: ${getShortRawValueTest}, hash: FE9C1CF20C4D81EB3EC648AEBAB851AE
    @Test()
    ...
    //Sapient generated method id: ${getShortValueTest}, hash: 582C7135EBDD016F475B156715D20D49
    @Test()
    ...
    //Sapient generated method id: ${getValueTest}, hash: 86A118710A6EB623C3876E012F7B597F
    @Test()
    void getValueTest() {
        //Arrange Statement(s)
        BitField target = new BitField(0);
    ...
    //Sapient generated method id: ${isAllSetWhenHolderAndMaskEqualsMask}, hash: 3CFD6D4CDA4EAAEA12FE7EF65BB9C86B
    @Test()
    ...
    //Sapient generated method id: ${isSetWhenHolderAndMaskEquals0}, hash: F965E69BDE27F1107715046C9C1C4372
    @Test()
    ...
    //Sapient generated method id: ${setTest}, hash: 890C5E83033F4CA6B7CEAC7ECF0588B2
    @Test()
    void setTest() {
        //Arrange Statement(s)
        BitField target = new BitField(0);
    ...
    //Sapient generated method id: ${setBooleanWhenFlag}, hash: 837E6E289F048332D7BA13C52F0BD9A8
    @Test()
    ...
    //Sapient generated method id: ${setBooleanWhenNotFlag}, hash: ECDEF7088BCEE3095AE1B4D2790E0976
    @Test()
    ...
    //Sapient generated method id: ${setByteTest}, hash: E08C2DF09C34D570A4C28F848CBB0A6D
    @Test()
    void setByteTest() {
        //Arrange Statement(s)
        BitField target = new BitField(0);
    ...
    //Sapient generated method id: ${setByteBooleanWhenFlag}, hash: FC49A837E750CDF2C788B49DB738D305
    @Test()
    ...
    //Sapient generated method id: ${setByteBooleanWhenNotFlag}, hash: 3F629EC0AF6C412998374A92BE1D2D79
    @Test()
    ...
    //Sapient generated method id: ${setShortTest}, hash: 1FD31A17DBA18D5F0D698897FBE3D7F5
    @Test()
    void setShortTest() {
        //Arrange Statement(s)
        BitField target = new BitField(0);
    ...
    //Sapient generated method id: ${setShortBooleanWhenFlag}, hash: 3B944665DBCD33220C4CEA1884557658
    @Test()
    ...
    //Sapient generated method id: ${setShortBooleanWhenNotFlag}, hash: 63A7A5BF30C73A32A7BE4EFD6E3C9566
    @Test()
    ...
    //Sapient generated method id: ${setShortValueTest}, hash: DC21E29BA5219DA9101BF64CE6996F16
    @Test()
    ...
    //Sapient generated method id: ${setValueTest}, hash: 705C9B3F157122308B8EB705E2745823
    @Test()
    void setValueTest() {
        //Arrange Statement(s)
        BitField target = new BitField(0);
